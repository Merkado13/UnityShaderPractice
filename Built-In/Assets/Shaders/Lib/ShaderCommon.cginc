#ifndef SHADER_COMMON_LIBRARY_INCLUDED
#define SHADER_COMMON_LIBRARY_INCLUDED
...
void InitLightingToon(half treshold, half smoothness, half3 shadowColor, half highlightSize,
    half highlightSmoothness, half3 hightlightColor)
{
    _ToonThreshold = treshold;
    _ToonSmoothness = smoothness;
    _ToonShadowColor = shadowColor; 
    _ToonGloss = highlightSize;
    _ToonGlossSmoothness = highlightSmoothness;
    _ToonGlossColor = hightlightColor;
