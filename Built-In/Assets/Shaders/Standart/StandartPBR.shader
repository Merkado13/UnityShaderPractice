Shader "Custom/StandartPBR"
{
    Properties
    {
		...
		_Metallic("Metallix", Range(0,1)) = 0
		...
		_ShowRim("Rim", int) = 1
		_ShowShiny("Metallic & Gloss Maps", int) = 1
...
#if defined(_SMOOTH_FIRSTA) || defined(_SMOOTH_FIRSTR) || !defined(_METAL_NONE) || defined(_AO_FIRSTB) || defined(_AO_FIRSTG)
